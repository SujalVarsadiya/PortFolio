            ...
            <div className='max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 shadow-md fixed top-0 left-0 right-0 z-50 bg-white'>
                <div className='flex justify-between items-center h-16'>
                    <div className='flex space-x-2'>
                        <img className='h-12 w-12 rounded-full' src="/public/photo.jpeg" alt="" />
                        <h1 className='font-semibold text-xl cursor-pointer'>Suja<span className='text-green-500 text-2xl'>l</span>
                    ...
                    <div>
                        ...
                        <div className='md:hidden' onClick={() => setMenu(!menu)}>{menu ? <IoCloseSharp size={24} /> : <AiOutlineMenu  size={24} />
                        }</div>
                    </div>
                </div>
